    ...
    var DayGrid = /** @class */ (function (_super) {
        ...
        DayGrid.prototype.renderNumberCellHtml = function (date) {
            ...
            if (isDayNumberVisible) {
                html += core.buildGotoAnchorHtml(view, date, { 'class': 'fc-day-number' }, dateEnv.format(date, DAY_NUM_FORMAT).replace("日","") // inner HTML

                );
                var cnMonth = CnMonthofDate(date);//农历月
                var cnDay = CnDayofDate(date);//农历日
                var cnMonDay = cnMonth+cnDay;
                html += core.buildGotoAnchorHtml(view, date, { 'class': 'fc-chineseday-number' },cnMonDay  // inner HTML
